...
mp.events.add("nSuccess", (text) => {
    mp.events.call("BN_Show", text, true, -1, 166);
});

mp.events.add("nWarning", (text) => {
    mp.events.call("BN_Show", text, true, -1, 168);
});

mp.events.add("nError", (text) => {
    mp.events.call("BN_Show", text, true, -1, 174);
});

mp.events.add("nInfo", (text) => {
    mp.events.call("BN_Show", text, true, -1, 159);
});
